    ...
    <div class="msite_shop_list">
        ...
        <div class="shop_container">
            <ul class="shop_list" v-if="shopList.length>0">
                <li class="shop_li border-1px" v-for="item in shopList">
                    <a>
                        <div class="shop_left">
                            <img class="shop_img" :src="imgUrl+item.image_path">
                        </div>
                        <div class="shop_right">
                            <section class="shop_detail_header">
                                <h4 class="shop_title ellipsis">{{ item.name}}</h4>
                                <ul class="shop_detail_ul">
                                    <li class="supports" v-for="icon in item.supports">{{icon.icon_name}}</li>
                                </ul>
                            </section>
                            <section class="shop_rating_order">
                                <section class="shop_rating_order_left">
                                     <stars class="star" :score="item.rating" :model="24"></stars>
